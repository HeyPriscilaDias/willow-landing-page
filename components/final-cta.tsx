    ...
    <section className="py-16 sm:py-24 bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="bg-gray-900 rounded-xl p-8 sm:p-12 lg:p-16 text-center shadow-2xl"
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={openModal}
              className="bg-white text-gray-900 px-8 py-4 rounded-xl hover:bg-gray-100 transition-colors font-semibold text-lg shadow-lg"
            >
              Request a Proposal
            </button>
            <button className="bg-transparent text-white px-8 py-4 rounded-xl hover:bg-white/10 transition-colors font-semibold text-lg border-2 border-white">
              Schedule a Demo
            </button>
          </div>
        </motion.div>
